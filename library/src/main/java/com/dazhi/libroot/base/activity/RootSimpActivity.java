...
public abstract class RootSimpActivity extends AppCompatActivity implements InteRootView {
    ...
    protected void permissionPhoneStorage() {
        RootSimpActivityPermissionsDispatcher.phoneStorageNeedWithPermissionCheck(this);
    }
    ...
    protected void permissionCamera() {
        RootSimpActivityPermissionsDispatcher.cameraNeedWithPermissionCheck(this);
    }
    ...
    protected void permissionLocation() {
        RootSimpActivityPermissionsDispatcher.locationNeedWithPermissionCheck(this);
    }
    ...
    protected void permissionContact() {
        RootSimpActivityPermissionsDispatcher.contactNeedWithPermissionCheck(this);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        //备注：将权限处理委托给生成的方法
        RootSimpActivityPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
